...
describe('cuid2', () => {
  test('should pass only cuid2s', () => {
    ...
    const value5 = 'mcl2p1g08lug6rl4z2u72aavwti9xa41';
    expect(cuid2({ checkLength: false })(value5).output).toBe(value5);

    expect(validate('').issue).toBeTruthy();
    expect(validate('An2bnhosk9fjfkcx38a9plzb').issue).toBeTruthy();
    expect(validate('g8sktlv9xj1s70qntgev7ro').issue).toBeTruthy();
    expect(validate('f5rmc7k8upzpouu17so66noej').issue).toBeTruthy();
